...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__startNonWorker_closure: {
    "^": "Closure:11;box_0,functionName_1,isSpawnUri_2,startPaused_3,replyPort_4",
    call$0: function() {
      var t1 = this.box_0;
...
["dart._internal", "dart:_internal", , H, {
  ...
  MappedIterator: {
    "^": "Iterator;__internal$_current,__internal$_iterator,_f",
    _f$1: function(arg0) {
...
["dart.async", "dart:async", , P, {
  ...
  _AsBroadcastStreamController: {
    ...
    }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 14, 5],
    close$0: [function(_) {
      var t1 = this._state;
      if ((t1 & 4) === 0 && (t1 & 2) !== 0) {
...
["dart.dom.html", "dart:html", , W, {
  ...
  HtmlElement: {
    "^": "Element;",
    "%": "HTMLAppletElement|HTMLBRElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFieldSetElement|HTMLFontElement|HTMLFrameElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLKeygenElement|HTMLLabelElement|HTMLLegendElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMetaElement|HTMLModElement|HTMLOptGroupElement|HTMLParagraphElement|HTMLPreElement|HTMLQuoteElement|HTMLShadowElement|HTMLSpanElement|HTMLTableCaptionElement|HTMLTableColElement|HTMLTemplateElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement;HTMLElement"
  },
  AnchorElement: {
  ...
  InputElement: {
    "^": "HtmlElement;type},value=,valueAsNumber%",
...
["dart.dom.indexed_db", "dart:indexed_db", , P, {
  ...
  _completeRequest_closure: {
    "^": "Closure:10;request_0,completer_1",
    call$1: function(e) {
      var t1, t2;
  ...
  ObjectStore__cursorStreamFromResult_closure: {
    "^": "Closure:10;request_0,autoAdvance_1,controller_2",
    call$1: function(e) {
      var cursor, t1;
...
["visits", "visits.dart", , R, {
  "^": "",
  main: [function() {
    var t1, t2, t3, t4, db, visitList, visitForm;
    if (!!(window.indexedDB || window.webkitIndexedDB || window.mozIndexedDB)) {
      t1 = $.VISITS_STORE;
      t2 = $.VISITS_DB;
      t3 = $.DATE_INDEX;
      t4 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      db = new V.DB(t1, t2, t3, null, t4);
      visitList = new R.VisitList(null, P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      visitList._table = document.querySelector("#visits_table");
      visitForm = R.VisitFormView$(db, visitList);
      t3 = window;
      J.open$3$onUpgradeNeeded$version$x(t3.indexedDB || t3.webkitIndexedDB || t3.mozIndexedDB, t2, db.get$_initializeDatabase(), 1).then$1(db.get$_loadFromDB()).then$1(visitList.drawList$2(t4.get$values(t4), visitForm)).catchError$1(R.onError$closure());
    } else {
      t1 = document.querySelector("#main_msg");
      t1.textContent = "Necesitas un navegador m\u00e1s moderno";
      J.get$classes$x(t1).add$1(0, "error");
    }
  }, "call$0", "main$closure", 0, 0, 2],
  onError: [function(e) {
    P.print(C.JSString_methods.$add("error opening ", J.toString$0(e)));
  }, "call$1", "onError$closure", 2, 0, 10],
  VisitList: {
    "^": "Object;_table,rows",
    drawList$2: function(visits, form) {
      var t1;
      for (t1 = visits._iterable, t1 = H.setRuntimeTypeInfo(new H.MappedIterator(null, t1.get$iterator(t1), visits._f), [H.getTypeArgumentByIndex(visits, 0), H.getTypeArgumentByIndex(visits, 1)]); t1.moveNext$0();)
        this.update$2(0, t1.__internal$_current, form);
    },
    update$2: function(_, visit, form) {
      var t1, row, t2, i, t3, t4;
      t1 = this.rows;
      if (t1.containsKey$1(J.getKey$0$x(visit)))
        row = t1.$index(0, visit.date.toString$0(0));
      else {
        row = J.addRow$0$x(this._table);
        for (t2 = J.getInterceptor$x(row), i = 0; i < 5; ++i)
          t2.addCell$0(row);
        row.toString;
        t2 = C.EventStreamProvider_click._eventType;
        t3 = new W._ElementEventStreamImpl(row, t2, false);
        t3.$builtinTypeInfo = [null];
        t4 = new W._EventStreamSubscription(0, row, t2, W._wrapZone(new R.VisitList_update_closure(visit, form)), false);
        t4.$builtinTypeInfo = [H.getTypeArgumentByIndex(t3, 0)];
        t3 = t4._onData;
        if (t3 != null && t4._pauseCount <= 0)
          J.addEventListener$3$x(t4._html$_target, t2, t3, false);
        t1.$indexSet(0, visit.date.toString$0(0), row);
      }
      t1 = J.get$cells$x(row)._list;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1[0].textContent = visit.date.toLocal$0().toString$0(0);
      t1 = row.cells;
      new W._WrappedList(t1).$builtinTypeInfo = [W.TableCellElement];
      if (1 >= t1.length)
        return H.ioore(t1, 1);
      t1[1].textContent = J.toString$0(visit.girls);
      t1 = row.cells;
      new W._WrappedList(t1).$builtinTypeInfo = [W.TableCellElement];
      if (2 >= t1.length)
        return H.ioore(t1, 2);
      t1[2].textContent = J.toString$0(visit.boys);
      t1 = row.cells;
      new W._WrappedList(t1).$builtinTypeInfo = [W.TableCellElement];
      if (3 >= t1.length)
        return H.ioore(t1, 3);
      t1[3].textContent = J.toString$0(visit.women);
      t1 = row.cells;
      new W._WrappedList(t1).$builtinTypeInfo = [W.TableCellElement];
      if (4 >= t1.length)
        return H.ioore(t1, 4);
      t1[4].textContent = J.toString$0(visit.men);
    }
  },
  VisitList_update_closure: {
    "^": "Closure:26;visit_0,form_1",
    call$1: function(e) {
      this.form_1.loadToFrom$1(this.visit_0);
    }
  },
  VisitFormView: {
    "^": "Object;_visit,_visits$_db,dateInput,boysInput,girslInput,menInput,womenInput,button,form",
    loadFromForm$0: function() {
      this._visit.boys = J.get$valueAsNumber$x(this.boysInput);
      this._visit.girls = J.get$valueAsNumber$x(this.girslInput);
      this._visit.men = J.get$valueAsNumber$x(this.menInput);
      this._visit.women = J.get$valueAsNumber$x(this.womenInput);
      this._visit.date = J.get$valueAsDate$x(this.dateInput);
      return this._visit;
    },
    loadToFrom$1: function(visit) {
      J.set$valueAsNumber$x(this.boysInput, visit.boys);
      J.set$valueAsNumber$x(this.girslInput, visit.girls);
      J.set$valueAsNumber$x(this.womenInput, visit.women);
      J.set$valueAsNumber$x(this.menInput, visit.men);
      J.set$valueAsDate$x(this.dateInput, visit.date);
      this.loadFromForm$0();
    },
    save$1: function(e) {
      var t1, t2, t3;
      ...
      this.loadFromForm$0();
      t1 = this._visits$_db.visits.containsKey$1(this._visit.date.toString$0(0));
      t2 = this._visits$_db;
      t3 = this._visit;
      if (t1)
        return t2.update$1(0, t3);
      else
        return t2.add$1(0, t3);
    },
    VisitFormView$2: function(db, list) {
      var t1, t2;
      t1 = new R.Visit(null, null, null, null, null);
      t1.Visit$0();
      this._visit = t1;
      this._visits$_db = db;
      this.dateInput = W.InputElement_InputElement("date");
      this.boysInput = W.InputElement_InputElement("number");
      this.girslInput = W.InputElement_InputElement("number");
      this.menInput = W.InputElement_InputElement("number");
      this.womenInput = W.InputElement_InputElement("number");
      t1 = document.createElement("button", null);
      this.button = t1;
      t1.id = "save";
      t1.textContent = "Salvar";
      t2 = J.getInterceptor$x(t1);
      t2.get$classes(t1).add$1(0, "important");
      t1 = t2.get$onClick(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new R.VisitFormView_closure(this, list)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.querySelector("#input_visits");
      this.form = t1;
      t1.appendChild(this.dateInput);
      this.form.appendChild(this.boysInput);
      this.form.appendChild(this.girslInput);
      this.form.appendChild(this.menInput);
      this.form.appendChild(this.womenInput);
      this.form.appendChild(this.button);
      this.loadToFrom$1(this._visit);
    },
    static: {VisitFormView$: function(db, list) {
        var t1 = new R.VisitFormView(null, null, null, null, null, null, null, null, null);
        t1.VisitFormView$2(db, list);
        return t1;
      }}
  },
  VisitFormView_closure: {
    "^": "Closure:10;this_0,list_1",
    call$1: function(e) {
      var t1 = this.this_0;
      return t1.save$1(e).then$1(new R.VisitFormView__closure(t1, this.list_1)).catchError$1(new R.VisitFormView__closure0());
    }
  },
  VisitFormView__closure: {
    "^": "Closure:10;this_2,list_3",
    call$1: function(visit) {
      return this.list_3.update$2(0, visit, this.this_2);
    }
  },
  VisitFormView__closure0: {
    "^": "Closure:10;",
    call$1: function(err) {
      return P.print(err);
    }
  ...
  Visit: {
    "^": "Object;date,boys,girls,men,women",
    toRaw$0: function() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["date", this.date.toString$0(0), "boys", this.boys, "girls", this.girls, "men", this.men, "women", this.women], null, null);
    },
    getKey$0: function(_) {
      return this.date.toString$0(0);
    },
    Visit$0: function() {
...
1],
["visits_db", "visits_db.dart", , V, {
  "^": "",
  DB: {
    "^": "Object;store,dbName,index,_db,visits",
    _initializeDatabase$1: [function(e) {
      var objectStore, options;
      objectStore = J.createObjectStore$2$autoIncrement$x(P.convertNativeToDart_AcceptStructuredClone(H.interceptedTypeCast(J.get$target$x(e), "$isRequest").result, false), this.store, true);
      objectStore.toString;
      options = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      options.$indexSet(0, "unique", true);
      J._createIndex$3$x(objectStore, this.index, "date", options);
    }, "call$1", "get$_initializeDatabase", 2, 0, 27],
    _loadFromDB$1: [function(db) {
      var t1, t2, t3, cursors;
      this._db = db;
      t1 = this.store;
      t1 = J.openCursor$1$autoAdvance$x(J.objectStore$1$x(J.transaction$2$x(db, t1, "readonly"), t1), true);
      t2 = H.getRuntimeTypeArgument(t1, "Stream", 0);
      t3 = $.Zone__current;
      t3.toString;
      cursors = H.setRuntimeTypeInfo(new P._AsBroadcastStream(t1, null, null, t3, null, null), [t2]);
      cursors._AsBroadcastStream$3(t1, null, null, t2);
      cursors.listen$1(new V.DB__loadFromDB_closure(this));
      return cursors.get$length(cursors).then$1(new V.DB__loadFromDB_closure0(this));
    }, "call$1", "get$_loadFromDB", 2, 0, 28],
    add$1: function(_, visit) {
      var visitAsMap, t1, transaction, t2;
      visitAsMap = visit.toRaw$0();
      t1 = this.store;
      transaction = J.transaction$2$x(this._db, t1, "readwrite");
      t2 = J.getInterceptor$x(transaction);
      J.add$2$ax(t2.objectStore$1(transaction, t1), visitAsMap, visit.date.toString$0(0)).then$1(new V.DB_add_closure(visit));
      return t2.get$completed(transaction).then$1(new V.DB_add_closure0(this, visit));
    },
    update$1: function(_, visit) {
      var visitAsMap, t1, transaction, t2;
      visitAsMap = visit.toRaw$0();
      t1 = this.store;
      transaction = J.transaction$2$x(this._db, t1, "readwrite");
      t2 = J.getInterceptor$x(transaction);
      J.put$2$x(t2.objectStore$1(transaction, t1), visitAsMap, visit.date.toString$0(0)).then$1(new V.DB_update_closure(visit)).catchError$1(new V.DB_update_closure0());
      return t2.get$completed(transaction).then$1(new V.DB_update_closure1(this, visit)).catchError$1(new V.DB_update_closure2());
    }
  },
  DB__loadFromDB_closure: {
    "^": "Closure:10;this_0",
    call$1: function(cursor) {
      var t1, t2, t3, t4, t5, t6;
      t1 = J.get$value$x(cursor);
      t2 = J.getInterceptor$asx(t1);
      t3 = P.DateTime_parse(t2.$index(t1, "date"));
      t4 = t2.$index(t1, "boys");
      t5 = t2.$index(t1, "girls");
      t6 = t2.$index(t1, "men");
      t1 = t2.$index(t1, "women");
      this.this_0.visits.$indexSet(0, t3.toString$0(0), new R.Visit(t3, t4, t5, t6, t1));
    }
  },
  DB__loadFromDB_closure0: {
    "^": "Closure:10;this_1",
    call$1: function(_) {
      return this.this_1.visits._collection$_length;
    }
  },
  DB_add_closure: {
    "^": "Closure:10;visit_0",
    call$1: function(addedKey) {
      var t1 = this.visit_0;
      if (t1.date.toString$0(0) === addedKey)
        P.print(C.JSString_methods.$add("ok: ", addedKey));
      else
        P.print(C.JSString_methods.$add("err: ", addedKey) + " != " + t1.date.toString$0(0));
    }
  },
  DB_add_closure0: {
    "^": "Closure:10;this_1,visit_2",
    call$1: function(_) {
      var t1 = this.visit_2;
      this.this_1.visits.$indexSet(0, t1.date.toString$0(0), t1);
      return t1;
    }
  },
  DB_update_closure: {
    "^": "Closure:10;visit_0",
    call$1: function(_) {
      return P.print("Updated " + this.visit_0.date.toString$0(0));
    }
  },
  DB_update_closure0: {
    "^": "Closure:10;",
...
R.Visit.$isVisit = true;
R.Visit.$isObject = true;
...
$.VISITS_STORE = "visitsStore";
$.VISITS_DB = "visitsDatabase";
...
function dart_precompiled($collectedClasses) {
  ...
  function MappedIterator(__internal$_current, __internal$_iterator, _f) {
    this.__internal$_current = __internal$_current;
    this.__internal$_iterator = __internal$_iterator;
    this._f = _f;
  }
  ...
  function _WrappedIterator(_iterator) {
  ...
  function VisitList(_table, rows) {
    this._table = _table;
    this.rows = rows;
  }
  VisitList.builtin$cls = "VisitList";
  if (!"name" in VisitList)
    VisitList.name = "VisitList";
  $desc = $collectedClasses.VisitList;
  if ($desc instanceof Array)
    $desc = $desc[1];
  VisitList.prototype = $desc;
  function VisitList_update_closure(visit_0, form_1) {
    this.visit_0 = visit_0;
    this.form_1 = form_1;
  }
  VisitList_update_closure.builtin$cls = "VisitList_update_closure";
  if (!"name" in VisitList_update_closure)
    VisitList_update_closure.name = "VisitList_update_closure";
  $desc = $collectedClasses.VisitList_update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  VisitList_update_closure.prototype = $desc;
  function VisitFormView(_visit, _visits$_db, dateInput, boysInput, girslInput, menInput, womenInput, button, form) {
    this._visit = _visit;
    this._visits$_db = _visits$_db;
    this.dateInput = dateInput;
    this.boysInput = boysInput;
    this.girslInput = girslInput;
    this.menInput = menInput;
    this.womenInput = womenInput;
    this.button = button;
    this.form = form;
  }
  VisitFormView.builtin$cls = "VisitFormView";
  if (!"name" in VisitFormView)
    VisitFormView.name = "VisitFormView";
  $desc = $collectedClasses.VisitFormView;
  if ($desc instanceof Array)
    $desc = $desc[1];
  VisitFormView.prototype = $desc;
  function VisitFormView_closure(this_0, list_1) {
    this.this_0 = this_0;
    this.list_1 = list_1;
  }
  VisitFormView_closure.builtin$cls = "VisitFormView_closure";
  if (!"name" in VisitFormView_closure)
    VisitFormView_closure.name = "VisitFormView_closure";
  $desc = $collectedClasses.VisitFormView_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  VisitFormView_closure.prototype = $desc;
  function VisitFormView__closure(this_2, list_3) {
    this.this_2 = this_2;
    this.list_3 = list_3;
  }
  VisitFormView__closure.builtin$cls = "VisitFormView__closure";
  if (!"name" in VisitFormView__closure)
    VisitFormView__closure.name = "VisitFormView__closure";
  $desc = $collectedClasses.VisitFormView__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  VisitFormView__closure.prototype = $desc;
  function VisitFormView__closure0() {
  }
  VisitFormView__closure0.builtin$cls = "VisitFormView__closure0";
  if (!"name" in VisitFormView__closure0)
    VisitFormView__closure0.name = "VisitFormView__closure0";
  $desc = $collectedClasses.VisitFormView__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  VisitFormView__closure0.prototype = $desc;
  function Visit(date, boys, girls, men, women) {
    this.date = date;
    this.boys = boys;
    this.girls = girls;
    this.men = men;
  ...
  Visit.builtin$cls = "Visit";
  if (!"name" in Visit)
    Visit.name = "Visit";
  $desc = $collectedClasses.Visit;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Visit.prototype = $desc;
  function DB(store, dbName, index, _db, visits) {
    this.store = store;
    this.dbName = dbName;
    this.index = index;
    this._db = _db;
